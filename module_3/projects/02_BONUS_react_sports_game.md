# React Sports Game
In this activity, you will build a simple sports game. This activity will exercise your comfort level with JSX, working with props, and leveraging local state within a stateful component. 

To get started you need to create a new project with create-react-app
...
```bash
  $ npx create-react-app react-sports-game
```

* Then open the `react-sports-game` project folder in VSCode or your editor of choice.
